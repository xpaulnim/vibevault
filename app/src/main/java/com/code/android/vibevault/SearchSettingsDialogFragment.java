...
public class SearchSettingsDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        seek = v.findViewById(R.id.NumResultsSeekBar);
        seek.setProgress(Integer.parseInt(db.getPref("numResults")) - 10);
        sortSpin = v.findViewById(R.id.SortSpinner);
        dateSpin = v.findViewById(R.id.DateSpinner);
        seekValue = v.findViewById(R.id.SeekBarValue);
        okayButton = v.findViewById(R.id.SettingsOkayButton);
        monthText = v.findViewById(R.id.MonthText);
        dayText = v.findViewById(R.id.DayText);
        yearText = v.findViewById(R.id.DateText);
